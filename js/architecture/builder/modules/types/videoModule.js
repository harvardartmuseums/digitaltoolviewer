...
function toggleVideo(video, vimeo) {
	if (video) {
		if (vimeo) {
...
function VideoModule(width, height, module) {
	...
	if (vimeo != null) {
		...
		videoElement.getElementsByTagName("iframe")[0].onload = function() {
			setTimeout(function() {
				generateCutout(mesh, videoElement, undefined, undefined, undefined, undefined, true, true, toggleVideo.bind(undefined, video, vimeo)); 
			}, 100);
		};
		...
		setTimeout(function() {
			generateCutout(mesh, videoElement, undefined, undefined, undefined, undefined, true, true, toggleVideo); 
		}, 100);
	}
